                ...
                if ($totalResults) {
                    ...
                    foreach ($results as $node) {
                        foreach ($node->getElementsByTagName('result') as $result) {
                            ...
                            if (isset($stateIndexes[strtoupper($state)]) && strtolower($country) == 'us') {
                                $state = $stateIndexes[strtoupper($state)];
                            }
                            ...
                            $indeedListings [$jobKey] = [
                                ...
                                'api' => 'indeed',
                                'code' => '<span id="indeed_at" class="backfilling__from"><a href="' . SJB_Request::getProtocol() . '://' . $indeedDomain . '/">jobs</a> by <a href="' . SJB_Request::getProtocol() . '://' . $indeedDomain . '/" title="Job Search"><img src="' . SJB_H::getSiteUrl() . '/templates/_system/main/images/indeed.gif" style="border: 0; vertical-align: middle;" alt="Indeed job search"></a></span>',

...
class SJB_SocialPlugin
{
    ...
    protected static $aUserFieldsNotRequiredInRegistration = ['password'];
    protected static $aUserFields = ['email', 'LastName'];
    protected static $aListingFields = [];
     ...
     * @return SocialLoginPlugin|FacebookSocialPlugin
     */
    ...
    /**
     * @return SocialLoginPlugin|FacebookSocialPlugin|null
     */
...
//	}
    ...
    public static function login()
    {
        if (self::$oSocialPlugin) {
            ...
            if ($userSID = self::ifUserIsRegistered(self::getNetwork())) {
                ...
                $GLOBALS[self::SOCIAL_LOGIN_ERROR] = [];
    ...
    {
        SJB_Session::setValue('sn', ['authorized' => true, 'network' => $network]);
    }

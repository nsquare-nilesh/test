...
<div class="col-xs-12 details-body__left applicants">
    {if $applications}
        <div class="col-xs-12">
            <h3 class="my-applications-title">[[My Applications]]</h3><br/>
        </div>
        <div id="applicants-list" class="col-xs-12 clearfix">
            {foreach item=application from=$applications name=applications}
                <article class="media well listing-item {if $listing.type.id eq 'Job'}listing-item__jobs{elseif $listing.type.id eq 'Resume'}listing-item__resumes{/if} clearfix">

...
<head>
    ...
    <link href="{$GLOBALS.site_url}/templates/Simplicity/assets/third-party/jquery-ui.css" rel="stylesheet">
    <link href="{$GLOBALS.site_url}/templates/Simplicity/vendor/twbs/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">

    <link href="{$GLOBALS.site_url}/templates/Simplicity/assets/style/styles.css" rel="stylesheet">
...
<body class="{if $url != '/'}body__inner{/if}{if 'banner_top'|banner} with-banner{/if}">
    ...
    <script src="{$GLOBALS.site_url}/templates/Simplicity/assets/third-party/jquery.min.js"></script>
    <!-- Include all compiled plugins (below), or include individual files as needed -->
    <script src="{$GLOBALS.site_url}/templates/Simplicity/vendor/twbs/bootstrap/dist/js/bootstrap.min.js"></script>

    <script src="{$GLOBALS.site_url}/templates/Simplicity/assets/third-party/jquery-ui.min.js"></script>

    <script language="JavaScript" type="text/javascript" src="{common_js}/main.js"></script>
    <script language="JavaScript" type="text/javascript" src="{$GLOBALS.site_url}/templates/Simplicity/assets/third-party/jquery.form.min.js"></script>
    <script language="JavaScript" type="text/javascript" src="{$GLOBALS.site_url}/system/ext/jquery/jquery.validate.min.js"></script>
    <script language="JavaScript" type="text/javascript" src="{$GLOBALS.site_url}/templates/Simplicity/common_js/autoupload_functions.js"></script>
    ...
    <script language="JavaScript" type="text/javascript" src="{$GLOBALS.site_url}/templates/Simplicity/common_js/multilist_functions.js"></script>
    <script>
        var langSettings = {

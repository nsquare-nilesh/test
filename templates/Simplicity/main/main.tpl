...
<head>
	...
	<link href="{$GLOBALS.site_url}/templates/Simplicity/assets/third-party/jquery.bxslider.css" rel="stylesheet">
...
<body class="{if $url != '/'}body__inner{/if}">
	...
	<script src="{$GLOBALS.site_url}/templates/Simplicity/assets/third-party/jquery.bxslider.min.js"></script>

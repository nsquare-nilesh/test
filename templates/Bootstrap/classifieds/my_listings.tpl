...
<div class="my-account-list">
    <ul class="nav nav-pills">
        ...
        {else}
            {title}[[My CV]]{/title}
            <li class="presentation active"><a href="{$GLOBALS.site_url}/my-listings/{$listingTypeID|lower}/">[[My CVs]]</a></li>
...
{if not $listings}
    <div class="search-results my-account-listings col-xs-12 {if $my_products}col-sm-9{else}my-account-listings-full{/if}">
        <div class="form-group__btn">
            ...
            {else}
                <a href="{$GLOBALS.site_url}/add-listing/?listing_type_id=Resume" class="btn btn__orange btn__bold">[[Create New CV]]</a>
            {/if}
        </div>

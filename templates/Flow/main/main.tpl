...
<head>
	...
	<link href="{$GLOBALS.site_url}/templates/Flow/assets/third-party/jquery.bxslider.css" rel="stylesheet">
...
<body class="{if $url != '/'}body__inner{/if}">
		...
		<div class="container container-fluid">
			...
			<div class="alert__block alert__block-form">
				<form action="{$GLOBALS.site_url}/guest-alerts/create/" method="post" id="create-alert" class="well alert__form">
					...
					<div class="form-group form-group__select alert__form__input">
	...
	<script src="{$GLOBALS.site_url}/templates/Flow/assets/third-party/jquery.bxslider.min.js"></script>

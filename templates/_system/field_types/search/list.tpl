...
{/if}
<select name='{$id}[multi_like][]' class="searchList" {if $parentID && !$list_values && !$enabled} disabled="disabled" {/if} {if $parentID && $locationName == "Country"} onchange = "get{$parentID}States(this.value)" {/if}>

...
<div style="min-height: 26px;">
	...
	<select multiple="multiple" style="display: none;" class="inputList fieldType{$id} {if $complexField}complexField{/if}" name="{if $complexField}{$complexField}[{$id}][{$complexStep}][]{else}{$id}[]{/if}">

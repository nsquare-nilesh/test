{breadcrumbs}<a href="{$GLOBALS.site_url}/promotions/">[[Discounts]]</a> / [[Edit Discount Code]]{/breadcrumbs}
<div class="page-title">
	<h1 class="title">[[Edit Discount Code]]</h1>
	<div class="page-title__buttons">
		<a href="{$GLOBALS.site_url}/promotions/log/{$sid}/" type="button" value="[[View log]]" class="btn btn--bordered">[[View log]]</a>
	</div>
</div>

...
<div style="min-height: 34px;">
	...
	<select multiple="multiple" style="display: none;" class="inputList {if $complexField}complexField{/if}" name="{if $complexField}{$complexField}[{$id}][{$complexStep}][]{else}{$id}[]{/if}">
